...
export default function Home() {
  return (
    <div className="">
      ...
      <div className='flex flex-col md:flex-row items-center justify-between md:pr-28 my-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 px-8 gap-x-8 gap-y-8'>

        <Link href={''} className=''>
          <div className='flex items-center flex-col justify-center bg-white h-[150px]'>
            <img style={{objectFit:'cover'}} className='w-full h-[100px]' src="/images/tools/free.png" />
          </div>
        ...
        <Link href={''} className=''>
          <div className='flex items-center flex-col justify-center bg-white h-[150px]'>
            <img style={{objectFit:'cover'}} className='w-full h-[100px]' src="/images/tools/envato.png" />
          </div>
        ...
        <Link href={''} className=''>
          <div className='flex items-center flex-col justify-center bg-white h-[150px]'>
            <img style={{objectFit:'cover'}} className='w-full h-[100px]' src="/images/tools/semrush.png" />
          </div>
        ...
        <Link href={''} className=''>
          <div className='flex items-center flex-col justify-center bg-white h-[150px]'>
            <img style={{objectFit:'cover'}} className='w-full h-[100px]' src="/images/tools/uk.png" />
          </div>
